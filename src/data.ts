export const data = {
  profile: {
    ...
    description:
      "Middle Fullstack Developer, like to learning about new technology",
  },
  about: [
    ...
    "After graduated i started new learning about framework started from vue js and Django(python) and build some web like movie list for small project what i learning. I have already experience 4 years for fullstack developer",
  ],
  experiences: [
    {
      from: "Agustus 2023",
      ...
      description: [
        "Develop Bomba Project Audit using Laravel, maintain and adding new module Honda Dealer Project using Angular Js, create new module Business Trip and Reimburse using Laravel(Inertia) in Mitshubisi Project, create and maintain rest api and collaboratio with mobile developer for ShesInfo Projec using Laravel Passport, maintain and creating new module Stock report in BismaService app using laravel",
      ],
    },
    {
      from: "Nov 2021",
...

    {
      ...
      position: "Freelance",
      tools: ["Flutter", "Laravel", "Flutter", "Mysql", "Next Js", "Nest JS"],
      description: [
        "Create and maintain project fixy Pay using next and nests js, Create project simple money management using Laravel and vueJs",
      ],
    },
